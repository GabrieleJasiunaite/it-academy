...
public class Runner implements Person {
    ...
    private Optional<Integer> finalPosition;
    ...
    public static class Builder {
        ...
        public Builder withFinalPosition(Integer number) {
            if(number == 0) {
                runner.finalPosition = Optional.empty();
            } else {
                runner.finalPosition = Optional.of(number);
            }
            return this;
        }
    ...
    public String toString() {
        return name + " (Id: " + personalId + ")" +
                ": starting number: " + startingNumber +
                "; final position: " + (finalPosition.isPresent() ? finalPosition.get() : "not finished;") +
                "; advantage points: " + advantagePoints +
    ...
    public Optional<Integer> getFinalPosition() {
